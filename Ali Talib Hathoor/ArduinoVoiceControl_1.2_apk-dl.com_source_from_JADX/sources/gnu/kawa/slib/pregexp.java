...
public class pregexp extends ModuleBody {
    ...
    public class frame0 extends ModuleBody {
        ...
        public Object lambda5loupOneOfChars(Object chars) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(frame1.chars), this.f18i, this.sk, frame1.lambda$Fn13);
        }
        ...
        public Object lambda7loupOr(Object res) {
            ...
            return this.staticLink.lambda3sub(lists.car.apply1(frame3.res), this.f18i, frame3.lambda$Fn15, frame3.lambda$Fn16);
        }
        ...
        public Object lambda8loupP(Object k, Object i) {
            ...
            frame4.f22k = k;
            frame4.f21i = i;
            if (Scheme.numLss.apply2(frame4.f22k, this.f19p) != Boolean.FALSE) {
                return this.staticLink.lambda3sub(this.re, frame4.f21i, frame4.lambda$Fn17, this.fk);
            }
            frame4.f23q = this.f20q != Boolean.FALSE ? AddOp.$Mn.apply2(this.f20q, this.f19p) : this.f20q;
            return frame4.lambda24loupQ(pregexp.Lit73, frame4.f21i);
        }
    }
    ...
    public class frame4 extends ModuleBody {
        ...
        public Object lambda24loupQ(Object k, Object i) {
            ...
            frame5.f24i = i;
            frame5.fk = frame5.fk;
            if (this.f23q == Boolean.FALSE ? this.f23q != Boolean.FALSE : Scheme.numGEq.apply2(frame5.f25k, this.f23q) != Boolean.FALSE) {
                return frame5.lambda26fk();
            }
            if (this.staticLink.maximal$Qu) {
                return this.staticLink.staticLink.lambda3sub(this.staticLink.re, frame5.f24i, frame5.lambda$Fn18, frame5.fk);
            }
            Boolean x = frame5.lambda26fk();
            return x == Boolean.FALSE ? this.staticLink.staticLink.lambda3sub(this.staticLink.re, frame5.f24i, frame5.lambda$Fn19, frame5.fk) : x;
        }
    }
    ...
    public class frame extends ModuleBody {
        ...
        public Object lambda3sub(Object re, Object i, Object sk, Object fk) {
            ...
            if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit10) != Boolean.FALSE) {
                if (Scheme.numEqu.apply2(frame0.f18i, this.start) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply2(frame0.sk, frame0.f18i);
                }
                return Scheme.applyToArgs.apply1(frame0.fk);
            } else if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit12) != Boolean.FALSE) {
                return Scheme.numGEq.apply2(frame0.f18i, this.f26n) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f18i) : Scheme.applyToArgs.apply1(frame0.fk);
            } else {
                ...
                if (Scheme.isEqv.apply2(frame0.re$1, pregexp.Lit26) != Boolean.FALSE) {
                    if (pregexp.isPregexpAtWordBoundary(this.f27s, frame0.f18i, this.f26n) != Boolean.FALSE) {
                        return Scheme.applyToArgs.apply2(frame0.sk, frame0.f18i);
                    }
                    return Scheme.applyToArgs.apply1(frame0.fk);
                    ...
                    Object obj2;
                    if (x ? Scheme.numLss.apply2(frame0.f18i, this.f26n) != Boolean.FALSE : x) {
                        ...
                        try {
                            ...
                            obj2 = frame0.f18i;
                            try {
                                return procedure.apply2(Char.make(strings.stringRef(charSequence, ((Number) obj2).intValue())), frame0.re$1) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, AddOp.$Pl.apply2(frame0.f18i, pregexp.Lit8)) : Scheme.applyToArgs.apply1(frame0.fk);
                            } catch (ClassCastException e) {
                        ...
                        try {
                            ...
                            try {
                                if (pregexp.isPregexpCheckIfInCharClass(Char.make(strings.stringRef(charSequence, ((Number) obj2).intValue())), frame0.re$1) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply2(frame0.sk, AddOp.$Pl.apply2(frame0.f18i, pregexp.Lit8));
                                }
                                return Scheme.applyToArgs.apply1(frame0.fk);
                    ...
                    if (x3 != null) {
                        ...
                        if (lists.isPair(frame0.re$1)) {
                            ...
                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit83) != Boolean.FALSE) {
                                if (Scheme.numGEq.apply2(frame0.f18i, this.f26n) != Boolean.FALSE) {
                                    return Scheme.applyToArgs.apply1(frame0.fk);
                                }
                                ...
                                return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f18i, frame0.lambda$Fn2, frame0.lambda$Fn3);
                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit5) != Boolean.FALSE) {
                                return frame0.lambda6loupSeq(lists.cdr.apply1(frame0.re$1), frame0.f18i);
                            } else {
                                ...
                                if (Scheme.isEqv.apply2(tmp, pregexp.Lit20) != Boolean.FALSE) {
                                    ...
                                    try {
                                        ...
                                        try {
                                            ...
                                            try {
                                                return pregexp.pregexpStringMatch(strings.substring(charSequence, intValue, ((Number) obj2).intValue()), this.f27s, frame0.f18i, this.f26n, frame0.lambda$Fn4, frame0.fk);
                                    ...
                                    return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f18i, frame0.lambda$Fn5, frame0.fk);
                                } else {
                                    if (Scheme.isEqv.apply2(tmp, pregexp.Lit103) != Boolean.FALSE) {
                                        return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f18i, this.identity, pregexp.lambda$Fn6) != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f18i) : Scheme.applyToArgs.apply1(frame0.fk);
                                    } else {
                                        if (Scheme.isEqv.apply2(tmp, pregexp.Lit104) != Boolean.FALSE) {
                                            return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f18i, this.identity, pregexp.lambda$Fn7) != Boolean.FALSE ? Scheme.applyToArgs.apply1(frame0.fk) : Scheme.applyToArgs.apply2(frame0.sk, frame0.f18i);
                                        } else {
                                            Object n$Mnactual;
                                            Object sn$Mnactual;
                                            ...
                                            if (Scheme.isEqv.apply2(tmp, pregexp.Lit105) != Boolean.FALSE) {
                                                ...
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply2(frame0.sk, frame0.f18i) : Scheme.applyToArgs.apply1(frame0.fk);
                                                ...
                                                this.f26n = n$Mnactual;
                                                this.sn = sn$Mnactual;
                                                return found$Mnit$Qu != Boolean.FALSE ? Scheme.applyToArgs.apply1(frame0.fk) : Scheme.applyToArgs.apply2(frame0.sk, frame0.f18i);
                                            } else if (Scheme.isEqv.apply2(tmp, pregexp.Lit109) != Boolean.FALSE) {
                                                found$Mnit$Qu = lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f18i, this.identity, pregexp.lambda$Fn10);
                                                ...
                                                if (x2 == Boolean.FALSE ? Scheme.isEqv.apply2(tmp, pregexp.Lit61) != Boolean.FALSE : x2 != Boolean.FALSE) {
                                                    ...
                                                    return lambda3sub(lists.cadr.apply1(frame0.re$1), frame0.f18i, frame0.lambda$Fn11, frame0.lambda$Fn12);
                                                    ...
                                                    try {
                                                        ...
                                                        frame0.f19p = lists.caddr.apply1(frame0.re$1);
                                                        frame0.f20q = lists.cadddr.apply1(frame0.re$1);
                                                        ...
                                                        return frame0.lambda8loupP(pregexp.Lit73, frame0.f18i);
                        ...
                        } else if (Scheme.numGEq.apply2(frame0.f18i, this.f26n) != Boolean.FALSE) {
                            return Scheme.applyToArgs.apply1(frame0.fk);
                        } else {
                            return pregexp.pregexpError$V(new Object[]{pregexp.Lit101});
                        }
                ...
                } else if (pregexp.isPregexpAtWordBoundary(this.f27s, frame0.f18i, this.f26n) != Boolean.FALSE) {
                    return Scheme.applyToArgs.apply1(frame0.fk);
                } else {
                    return Scheme.applyToArgs.apply2(frame0.sk, frame0.f18i);
                }
