...
public class genwrite extends ModuleBody {
    ...
    public static Object genericWrite(Object obj, Object isDisplay, Object width, Object output) {
        ...
        frame.display$Qu = isDisplay;
        frame.width = width;
        frame.output = output;
        if (frame.width == Boolean.FALSE) {
            return frame.lambda5wr(obj, Lit1);
        }
        CharSequence makeString = strings.makeString(1, Lit0);
        IntNum intNum = Lit1;
        frame0 frame0 = new frame0();
        frame0.staticLink = frame;
        Procedure procedure = frame0.pp$Mnexpr;
        Procedure procedure2 = frame0.pp$Mnexpr$Mnlist;
        Procedure procedure3 = frame0.pp$MnLAMBDA;
        Procedure procedure4 = frame0.pp$MnIF;
        Procedure procedure5 = frame0.pp$MnCOND;
        Procedure procedure6 = frame0.pp$MnCASE;
        Procedure procedure7 = frame0.pp$MnAND;
        Procedure procedure8 = frame0.pp$MnLET;
        Procedure procedure9 = frame0.pp$MnBEGIN;
        frame0.pp$MnDO = frame0.pp$MnDO;
        frame0.pp$MnBEGIN = procedure9;
        frame0.pp$MnLET = procedure8;
        frame0.pp$MnAND = procedure7;
        frame0.pp$MnCASE = procedure6;
        frame0.pp$MnCOND = procedure5;
        frame0.pp$MnIF = procedure4;
        frame0.pp$MnLAMBDA = procedure3;
        frame0.pp$Mnexpr$Mnlist = procedure2;
        frame0.pp$Mnexpr = procedure;
        return frame.lambda4out(makeString, frame0.lambda7pr(obj, intNum, Lit1, frame0.pp$Mnexpr));
    }
