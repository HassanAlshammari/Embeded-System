...
public class conditions extends ModuleBody {
    ...
    public static condition makeCompoundCondition$V(Object condition$Mn1, Object[] argsArray) {
        ...
        return new condition(procedure.apply2(append, LList.reverseInPlace(result)));
    }
    ...
    public static condition extractCondition(condition condition, Mntype type) {
        ...
        frame.type = type;
        Boolean entry = srfi1.find(frame.lambda$Fn1, condition.type$Mnfield$Mnalist);
        if (entry == Boolean.FALSE) {
            misc.error$V("extract-condition: invalid condition type", new Object[]{condition, frame.type});
        }
        Mntype mntype = frame.type;
        Object arg0 = frame.type.all$Mnfields;
        Pair result = LList.Empty;
        while (arg0 != LList.Empty) {
            try {
                Pair arg02 = (Pair) arg0;
    ...
    static Object conditionMessage(Object condition) {
        try {
            condition condition2 = (condition) condition;
            Object obj = $Ammessage;
            try {
                return conditionRef(extractCondition(condition2, (Mntype) obj), Lit5);
            } catch (ClassCastException e) {
