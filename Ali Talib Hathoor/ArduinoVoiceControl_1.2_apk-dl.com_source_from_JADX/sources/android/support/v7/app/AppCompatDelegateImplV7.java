...
class AppCompatDelegateImplV7 extends AppCompatDelegateImplBase implements Callback, LayoutInflaterFactory {
    ...
    class C03902 implements OnApplyWindowInsetsListener {
        C03902() {
        }
    ...
    class C03913 implements OnFitSystemWindowsListener {
        C03913() {
        }
        ...
        if (!this.mSubDecorInstalled) {
            ...
            if (this.mWindowNoTitle) {
                ...
                if (VERSION.SDK_INT >= 21) {
                    ViewCompat.setOnApplyWindowInsetsListener(this.mSubDecor, new C03902());
                } else {
                    ((FitWindowsViewGroup) this.mSubDecor).setOnFitSystemWindowsListener(new C03913());
                }
