...
public class WindowDecorActionBar extends ActionBar implements ActionBarVisibilityCallback {
    ...
    final ViewPropertyAnimatorListener mHideListener = new C04351();
    ...
    final ViewPropertyAnimatorListener mShowListener = new C04362();
    ...
    final ViewPropertyAnimatorUpdateListener mUpdateListener = new C03933();

    /* renamed from: android.support.v7.internal.app.WindowDecorActionBar$3 */
    class C03933 implements ViewPropertyAnimatorUpdateListener {
        C03933() {
        }
    ...
    class C04351 extends ViewPropertyAnimatorListenerAdapter {
        C04351() {
        }
    ...
    class C04362 extends ViewPropertyAnimatorListenerAdapter {
        C04362() {
        }
