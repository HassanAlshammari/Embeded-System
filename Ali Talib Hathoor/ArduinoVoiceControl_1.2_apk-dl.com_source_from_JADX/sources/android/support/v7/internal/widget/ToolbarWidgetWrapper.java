...
public class ToolbarWidgetWrapper implements DecorToolbar {
    ...
    class C04402 extends ViewPropertyAnimatorListenerAdapter {
    ...
    class C04413 extends ViewPropertyAnimatorListenerAdapter {
        C04413() {
        }
    ...
    public void animateToVisibility(int visibility) {
        if (visibility == 8) {
            ViewCompat.animate(this.mToolbar).alpha(0.0f).setListener(new C04402());
        } else if (visibility == 0) {
            ViewCompat.animate(this.mToolbar).alpha(1.0f).setListener(new C04413());
        }
    }
