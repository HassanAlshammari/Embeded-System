...
public class Rectangle extends PolygonBase implements MapRectangle {
    private static final MapFeatureVisitor<Double> distanceComputation = new C04111();
    private double east = 0.0d;
    private double north = 0.0d;
    private double south = 0.0d;
    private double west = 0.0d;

    /* renamed from: com.google.appinventor.components.runtime.Rectangle$1 */
    static class C04111 implements MapFeatureVisitor<Double> {
        C04111() {
        }
