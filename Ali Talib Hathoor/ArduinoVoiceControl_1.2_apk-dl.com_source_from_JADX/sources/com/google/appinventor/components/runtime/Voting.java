...
public class Voting extends AndroidNonvisibleComponent implements Component {
    ...
    class C04152 implements AsyncCallbackPair<JSONObject> {
    ...
    class C04164 implements AsyncCallbackPair<String> {
    ...
    private void postRequestBallot() {
        WebServiceUtil.getInstance().postCommandReturningObject(this.serviceURL, REQUESTBALLOT_COMMAND, null, new C04152());
    }
    ...
    private void postSendBallot(String userChoice, String userId) {
        AsyncCallbackPair<String> myCallback = new C04164();
