...
public abstract class MapFeatureContainerBase extends AndroidViewComponent implements MapFeatureContainer {
    ...
    private final MapFeatureVisitor<Void> featureAdder = new C04061();
    protected List<MapFeature> features = new CopyOnWriteArrayList();

    /* renamed from: com.google.appinventor.components.runtime.MapFeatureContainerBase$1 */
    class C04061 implements MapFeatureVisitor<Void> {
        C04061() {
        }
