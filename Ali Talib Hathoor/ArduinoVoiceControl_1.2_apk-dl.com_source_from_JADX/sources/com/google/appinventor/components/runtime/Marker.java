...
public class Marker extends MapFeatureBaseWithFill implements MapMarker {
    ...
    private static final MapFeatureVisitor<Double> bearingComputation = new C04082();
    private static final MapFeatureVisitor<Double> distanceComputation = new C04071();
    ...
    /* renamed from: com.google.appinventor.components.runtime.Marker$1 */
    static class C04071 implements MapFeatureVisitor<Double> {
        C04071() {
        }
    ...
    /* renamed from: com.google.appinventor.components.runtime.Marker$2 */
    static class C04082 implements MapFeatureVisitor<Double> {
        C04082() {
        }
