...
public final class GeoJSONUtil {
    ...
    static class C04171 implements PropertyApplication {
        C04171() {
        }
    ...
    static class C04182 implements PropertyApplication {
        C04182() {
        }
    ...
    static class C04193 implements PropertyApplication {
        C04193() {
        }
    ...
    static class C04204 implements PropertyApplication {
        C04204() {
        }
    ...
    static class C04215 implements PropertyApplication {
        C04215() {
        }
    ...
    static class C04226 implements PropertyApplication {
        C04226() {
        }
    ...
    static class C04237 implements PropertyApplication {
        C04237() {
        }
    ...
    static class C04248 implements PropertyApplication {
        C04248() {
        }
    ...
    static class C04259 implements PropertyApplication {
        C04259() {
        }
    ...
    static {
        ...
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_HORIZONTAL.toLowerCase(), new C04171());
        SUPPORTED_PROPERTIES.put(PROPERTY_ANCHOR_VERTICAL.toLowerCase(), new C04182());
        SUPPORTED_PROPERTIES.put(PROPERTY_DESCRIPTION, new C04193());
        SUPPORTED_PROPERTIES.put(PROPERTY_DRAGGABLE, new C04204());
        SUPPORTED_PROPERTIES.put(PROPERTY_FILL, new C04215());
        SUPPORTED_PROPERTIES.put(PROPERTY_HEIGHT, new C04226());
        SUPPORTED_PROPERTIES.put(PROPERTY_IMAGE, new C04237());
        SUPPORTED_PROPERTIES.put(PROPERTY_INFOBOX, new C04248());
        SUPPORTED_PROPERTIES.put(PROPERTY_STROKE, new C04259());
